...
# Making logging file system
logging.basicConfig(filename='sync.log', level=logging.INFO,
                    format='%(asctime)s - %(levelname)s - %(message)s')

# Config for Spotify API
SPOTIFY_CLIENT_ID = os.getenv('CLIENT_ID') or ''
SPOTIFY_CLIENT_SECRET = os.getenv('CLIENT_SECRET') or ''
SPOTIFY_REDIRECT_URI = os.getenv('REDIRECT_URI') or ''
...
def main():
    # Previously added tracks and albums
